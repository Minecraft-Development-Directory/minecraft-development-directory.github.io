...
For a long time, there has been no central hub for Minecraft developers to find the resources they need. There was still places like *Wiki.vg* (which has then moved to [Minecraft Wiki](https://minecraft.wiki/w/Minecraft_Wiki\:Protocol_documentation){rel="nofollow"})
and various community forums (like [Minecraft Forum](https://www.minecraftforum.net/){rel="nofollow"} or [Minecraft Forge France](https://www.minecraftforgefrance.fr/){rel="nofollow"}) but no single place to find everything.
...
We welcome contributions from the community! If you have a resource, tool, or tutorial that you think would be valuable to other Minecraft developers, please reach out to us on our [GitHub repository](https://github.com/Minecraft-Development-Directory/minecraft-development-directory.github.io/discussions){rel="nofollow"}.
